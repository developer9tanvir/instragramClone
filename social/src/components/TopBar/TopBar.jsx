...
const TopBar = () => {
  ...
  return (
    <div className='rop-ber-container'>
        <div className="top-ber-warper">
            ...
            <div className="top-ber-menu">
                <ul>
                    ...
                    <li>
                        <a href="#"><img src={ `${ user.photo ? user.photo : 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSpqwxWvbMEIgFui8MAhF31OycLB1acIB96E_A8pETexCpCS_5eI4Csil5tTJEvsnds_xw&usqp=CAU' }` } alt="" /></a>
                    </li>
                </ul>
            </div>
        </div>
